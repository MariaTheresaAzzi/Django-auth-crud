...
from .views import home, register_view, login_view, logout_view, create_patient, update_patient, delete_patient, doctor_list, create_doctor, patient_list, view_patient
...
urlpatterns = [
    ...
    path('view-patient/<int:pk>/', view_patient, name='view-patient'),
